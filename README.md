...
|---------------------|---------------------|--------------|
| Actualiza conceptos y <br> conocimientos necesarios para su <br> desarrollo profesional y en especial <br> para su proyecto en <br> soluciones de software. | **Rodrigo, Alcántara**<br>TB1:<br>- Contribuyó transversalmente al Capítulo I (1.1–1.3) y Capítulo II (2.1–2.6), articulando la visión de la solución con el diseño técnico.<br>- En Cap. I: apoyó 1.1 Startup Profile y 1.2 Solution Profile; participó en 1.2.2 Lean UX (problemas, hipótesis, canvas).<br>- En Cap. II: colaboró en 2.5 DDD estratégico (EventStorming, Context Mapping) y 2.5.3 Arquitectura (Context, Containers, Deployment), vinculándolo con 2.6 DDD táctico.<br>- Integró evidencias y referencias cruzadas en el README y la carpeta Images/ para mantener trazabilidad.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]<br>**Eric, Agama**<br>TB1:<br>- Contribuyó a Cap. I (1.1–1.3) y Cap. II (2.1–2.6) desde el soporte a prototipado y validación temprana.<br>- En Cap. I: apoyó 1.2 Solution Profile y 1.2.2 Lean UX materializando supuestos en un prototipo base (Vite + Vue).<br>- En Cap. II: colaboró en 2.2 Entrevistas y 2.3 Needfinding (preparación de guion, registro, síntesis) y levantó un servidor mock para pruebas de 2.4–2.6.<br>- Documentó pautas de estilo y configuraciones de entorno para mantener coherencia entre requisitos y UI.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]<br>**Alejandro, Barturen**<br>TB1:<br>- Focalizó su aporte en Cap. I (1.2.2 Lean UX) y Cap. II (2.1, 2.2, 2.3), asegurando coherencia entre problema, usuarios y requisitos.<br>- En Cap. I: elaboró problem statements, hipótesis y canvas; definió segmentos y pain points.<br>- En Cap. II: diseñó entrevistas (2.2.1), registró y analizó resultados (2.2.2–2.2.3); desarrolló Personas, Empathy Maps y Journey (2.3).<br>- Integró hallazgos en 2.4 (User Stories, Impact Mapping) para alimentar el backlog inicial.<br>TP:<br>[texto].<br>TB2:<br>[Texto]<br>TF:<br>[Texto]<br>**Rodrigo, Mechan**<br>TB1:<br>- Articuló el puente Cap. I → Cap. II transformando hallazgos de Lean UX en modelos y backlog priorizado.<br>- En Cap. I: consolidó visión y supuestos de 1.2.2 Lean UX.<br>- En Cap. II: condujo sesiones de 2.5.1 EventStorming y 2.5.2 Context Mapping; definió historias y priorización (2.4.1–2.4.3) y preparó evidencias.<br>- Alineó criterios de aceptación y Definition of Done con el lenguaje del dominio.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]<br>**Victor, Ortiz**<br>TB1:<br>- Aseguró consistencia entre la definición del producto (Cap. I) y el diseño de datos/servicios (Cap. II).<br>- En Cap. I: revisó objetivos, alcance y segmentos (1.1, 1.2, 1.3) para alinear el modelo de información.<br>- En Cap. II: modeló entidades y relaciones por bounded context (2.6) y validó flujos de información; preparó colecciones de prueba para 2.5.3/2.6.<br>- Mantuvo referencias de artefactos y checklist de calidad en el repositorio para trazabilidad.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]. | TB1: Integramos de forma consistente los entregables de Capítulo I (perfil de startup, segmentos y Lean UX) y Capítulo II (entrevistas/needfinding, historias, DDD estratégico y táctico, arquitectura), actualizando y aplicando conceptos directamente al proyecto; el resultado fue un set de requisitos priorizados y un diseño técnico trazable desde el problema hasta la solución, reduciendo ambigüedades y alineando dominio, datos y servicios. |
| Reconoce la necesidad del <br> aprendizaje permanente para el <br>  desempeño profesional y el <br> desarrollo de proyectos en <br> soluciones de software. | **Rodrigo, Alcántara**<br>TB1:<br>- Se capacitó en DDD, Clean Architecture y C4 Model para enlazar Cap. I con Cap. II (2.5–2.6).<br>- Practicó elaboración de diagramas y versionado de API para sostener arquitectura y trazabilidad entre capítulos.<br>- Participó en revisiones internas compartiendo lecciones aprendidas del Cap. I–II.<br>- Registró aprendizajes y gaps para los siguientes sprints.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]<br>**Eric, Agama**<br>TB1:<br>- Reforzó Lean UX básico para interpretar 1.2.2 y traducirlo a prototipos; estudió Vue (Composition API/Router) y mock APIs para validar 2.4–2.6.<br>- Experimentó con accesibilidad y pruebas de componentes para elevar la calidad del Cap. II.<br>- Adoptó convenciones de commits y versionado semántico para ordenar la documentación técnica.<br>- Compartió micro-sesiones sobre estructura de frontend y consumo de APIs con el equipo.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]<br>**Alejandro, Barturen**<br>TB1:<br>- Estudió heurísticas de Nielsen, técnicas de entrevista y síntesis de insights aplicadas en 2.2–2.3.<br>- Revisó guías de Lean UX para robustecer 1.2.2 y su impacto en requisitos (2.4).<br>- Formalizó criterios de redacción y registro de evidencias para reproducibilidad de Cap. I–II.<br>- Lideró espacios de feedback para homogeneizar el lenguaje del dominio en el documento.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[Texto]<br>**Rodrigo, Mechan**<br>TB1:<br>- Se formó en EventStorming, especificación de historias y priorización para conectar hallazgos de Cap. I con el diseño de Cap. II.<br>- Profundizó en GitFlow y manejo de issues para coordinar el avance entre capítulos.<br>- Practicó validación de flujos (comandos, eventos, políticas) con ejemplos guiados.<br>- Documentó lecciones aprendidas y acciones de mejora continua del equipo.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]<br>**Victor, Ortiz**<br>TB1:<br>- Aprendió modelado orientado al dominio y diseño de APIs REST para sustentar 2.6 a partir de la visión del Cap. I.<br>- Reforzó SQL y normalización para proponer esquemas iniciales alineados al dominio.<br>- Preparó guías de prueba y un glosario de términos para acelerar el aprendizaje del equipo.<br>- Se comprometió con el seguimiento de métricas de calidad para iteraciones futuras.<br>TP:<br>[texto]<br>TB2:<br>[texto]<br>TF:<br>[texto]| TB1: Mantuvimos un plan de aprendizaje activo y colaborativo (DDD, Clean Architecture, C4, UX Research, Vue 3, pruebas y GitFlow), con micro-sesiones internas, práctica guiada y registro de lecciones; esto fortaleció la calidad de los entregables de los Capítulos I–II y nuestra capacidad de iteración continua, impactando en una documentación más clara, un diseño más coherente y mejores criterios de validación. |
...
<img src="Images/SungKang.png">
<img src="Images/MatiasZagazeta.png">
...
| Epic/Story ID | Título | Descripción | Criterios de Aceptación | Relacionado con (Epic ID) |
|----------------|--------|-------------|--------------------------|--------------------------|
| **US01** | Información clara sobre Certiweb | Como visitante quiero entender de inmediato qué es Certiweb y qué beneficios ofrece para decidir si usarlo. | **Scenario 1:**<br>**Dado** que ingreso a la landing page,<br>**Cuando** leo el contenido destacado,<br>**Entonces** entiendo claramente que Certiweb ofrece inspección técnica y certificación para autos usados.<br><br>**Scenario 2:**<br>**Dado** que soy un visitante interesado,<br>**Cuando** bajo por la página,<br>**Entonces** veo ejemplos visuales (sellos, informes, beneficios) que explican los servicios. | EPIC01 |
| **US02** | Testimonios y casos de éxito | Como visitante quiero leer experiencias de otros usuarios para ganar confianza en el servicio. | **Scenario 1:**<br>**Dado** que estoy navegando en la landing,<br>**Cuando** bajo hasta la sección de testimonios,<br>**Entonces** veo citas reales de compradores, revendedores o vendedores satisfechos.<br><br>**Scenario 2:**<br>**Dado** que estoy interesado en el servicio,<br>**Cuando** hago clic en un testimonio,<br>**Entonces** puedo leer una historia completa de éxito. | EPIC01 |
| **US03** | Botón de acción claro | Como visitante quiero ver botones visibles para registrarme o solicitar una inspección para comenzar fácilmente. | **Scenario 1:**<br>**Dado** que estoy en la página principal,<br>**Cuando** llego al primer scroll,<br>**Entonces** veo botones como “Solicita tu inspección” o “Empieza ahora” que me llevan al registro o agendamiento.<br><br>**Scenario 2:**<br>**Dado** que estoy en una sección específica,<br>**Cuando** veo un botón de acción,<br>**Entonces** puedo acceder directamente al formulario de contacto. | EPIC01 |
| **US04** | Compatibilidad móvil del Landing Page | Como visitante desde celular quiero que el sitio web se vea bien y sea fácil de usar desde mi dispositivo para navegar sin complicaciones. | **Scenario 1:**<br>**Dado** que ingreso a la página desde mi teléfono,<br>**Cuando** navego por las secciones,<br>**Entonces** todos los elementos deben ajustarse correctamente al tamaño de pantalla sin desbordes ni errores de maquetación.<br><br>**Scenario 2:**<br>**Dado** que estoy usando la navegación móvil,<br>**Cuando** toco botones o enlaces,<br>**Entonces** estos deben ser accesibles con el dedo y tener un diseño táctil adecuado. | EPIC01 |
| **US05** | Solicitud de inspección | Como vendedor individual quiero solicitar la inspección técnica de mi auto para poder publicarlo con respaldo técnico. | **Scenario 1:**<br>**Dado** que deseo solicitar una inspección,<br>**Cuando** ingreso los datos del vehículo y elijo fecha y lugar,<br>**Entonces** el sistema registra mi solicitud y muestra el estado “pendiente”.<br><br>**Scenario 2:**<br>**Dado** que deseo modificar mi cita,<br>**Cuando** actualizo la fecha o datos del vehículo,<br>**Entonces** la solicitud se actualiza correctamente y recibo confirmación. | EPIC02 |
| **US06** | Visualización del informe técnico | Como vendedor individual quiero ver el informe técnico de mi auto para compartirlo con interesados. | **Scenario 1:**<br>**Dado** que la inspección ha sido completada,<br>**Cuando** ingreso al panel del vehículo,<br>**Entonces** puedo ver y descargar el informe generado.<br><br>**Scenario 2:**<br>**Dado** que necesito compartir el informe,<br>**Cuando** selecciono la opción de compartir,<br>**Entonces** puedo enviar un enlace directo a los interesados. | EPIC02 |
| **US07** | Publicación del sello de certificación | Como vendedor individual quiero incluir un sello de certificación en mi anuncio en línea para generar mayor confianza. | **Scenario 1:**<br>**Dado** que el auto cuenta con una inspección aprobada,<br>**Cuando** accedo a la ficha del vehículo,<br>**Entonces** puedo copiar el código para incluir el sello en portales de autos.<br><br>**Scenario 2:**<br>**Dado** que estoy editando mi anuncio,<br>**Cuando** inserto el código del sello,<br>**Entonces** el sello se muestra correctamente en la vista previa. | EPIC02 |
| **US08** | Historial de inspecciones | Como vendedor individual quiero ver un historial de las inspecciones realizadas a mis autos para tener trazabilidad técnica de cada uno. | **Scenario 1:**<br>**Dado** que tengo vehículos inspeccionados anteriormente,<br>**Cuando** accedo a mi historial,<br>**Entonces** puedo ver fecha, resultados y descargar informes antiguos.<br><br>**Scenario 2:**<br>**Dado** que necesito revisar un informe específico,<br>**Cuando** busco por fecha o vehículo,<br>**Entonces** puedo acceder rápidamente al informe deseado. | EPIC02 |
| **US09** | Registro de usuarios | Como usuario nuevo quiero registrarme en la plataforma para acceder a los servicios de Certiweb. | **Scenario 1:**<br>**Dado** que deseo crear una cuenta,<br>**Cuando** ingreso mis datos personales y correo electrónico,<br>**Entonces** el sistema crea mi usuario y me envía un correo de confirmación.<br><br>**Scenario 2:**<br>**Dado** que ya tengo cuenta,<br>**Cuando** intento registrarme nuevamente,<br>**Entonces** el sistema me notifica que el correo ya está en uso. | EPIC03 |
| **US10** | Inicio de sesión | Como usuario quiero iniciar sesión con mis credenciales para acceder a mis servicios. | **Scenario 1:**<br>**Dado** que tengo una cuenta registrada,<br>**Cuando** ingreso mi usuario y contraseña,<br>**Entonces** el sistema valida las credenciales y me dirige al panel principal.<br><br>**Scenario 2:**<br>**Dado** que ingreso credenciales incorrectas,<br>**Cuando** intento iniciar sesión,<br>**Entonces** el sistema muestra un mensaje de error. | EPIC03 |
| **US11** | Recuperación de contraseña | Como usuario quiero recuperar mi contraseña en caso de olvidarla. | **Scenario 1:**<br>**Dado** que olvidé mi contraseña,<br>**Cuando** hago clic en “Olvidé mi contraseña”,<br>**Entonces** el sistema envía un enlace al correo para restablecerla.<br><br>**Scenario 2:**<br>**Dado** que ya solicité un enlace,<br>**Cuando** intento usarlo después de 24 horas,<br>**Entonces** el sistema indica que el enlace ha expirado. | EPIC03 |
| **US12** | Gestión de perfil | Como usuario quiero actualizar mis datos personales para mantener mi cuenta al día. | **Scenario 1:**<br>**Dado** que estoy autenticado,<br>**Cuando** modifico mi nombre o teléfono,<br>**Entonces** el sistema guarda los cambios correctamente.<br><br>**Scenario 2:**<br>**Dado** que intento ingresar un correo ya registrado,<br>**Cuando** guardo los cambios,<br>**Entonces** el sistema me advierte del conflicto. | EPIC03 |
| **US13** | Panel de administración | Como administrador quiero gestionar usuarios, vehículos e inspecciones desde un panel centralizado. | **Scenario 1:**<br>**Dado** que soy administrador,<br>**Cuando** ingreso al panel,<br>**Entonces** veo estadísticas y accesos directos a las secciones de gestión.<br><br>**Scenario 2:**<br>**Dado** que necesito eliminar un registro,<br>**Cuando** lo selecciono,<br>**Entonces** el sistema solicita confirmación antes de eliminar. | EPIC04 |
| **US14** | Gestión de inspectores | Como administrador quiero asignar inspectores a las solicitudes de revisión. | **Scenario 1:**<br>**Dado** que hay solicitudes pendientes,<br>**Cuando** selecciono una y asigno un inspector,<br>**Entonces** el sistema actualiza su estado a “En proceso”.<br><br>**Scenario 2:**<br>**Dado** que un inspector ya tiene muchas tareas,<br>**Cuando** intento asignarle otra,<br>**Entonces** el sistema muestra una alerta de carga laboral. | EPIC04 |
| **US15** | Validación del reporte | Como inspector quiero validar los resultados del informe antes de enviarlo al cliente. | **Scenario 1:**<br>**Dado** que completé una inspección,<br>**Cuando** reviso los resultados,<br>**Entonces** puedo confirmar o corregir datos antes de publicarlo.<br><br>**Scenario 2:**<br>**Dado** que confirmo los resultados,<br>**Cuando** envío el informe,<br>**Entonces** el sistema lo marca como “Validado”. | EPIC04 |
| **US16** | Dashboard de métricas | Como administrador quiero ver estadísticas de inspecciones, usuarios y reportes para la toma de decisiones. | **Scenario 1:**<br>**Dado** que accedo al panel de control,<br>**Cuando** se cargan los datos,<br>**Entonces** veo gráficos actualizados con indicadores clave.<br><br>**Scenario 2:**<br>**Dado** que deseo exportar los datos,<br>**Cuando** hago clic en “Exportar”,<br>**Entonces** el sistema genera un archivo descargable. | EPIC04 |
| **US17** | Buscador de autos certificados | Como comprador quiero buscar autos que tengan certificado de inspección para asegurar su calidad. | **Scenario 1:**<br>**Dado** que ingreso al buscador,<br>**Cuando** escribo el modelo o placa,<br>**Entonces** el sistema muestra los autos certificados disponibles.<br><br>**Scenario 2:**<br>**Dado** que no existen resultados,<br>**Cuando** realizo la búsqueda,<br>**Entonces** el sistema muestra un mensaje informativo. | EPIC05 |
| **US18** | Filtro de estado de inspección | Como comprador quiero filtrar autos según el estado de inspección (Aprobado, En revisión, No aprobado). | **Scenario 1:**<br>**Dado** que abro el buscador,<br>**Cuando** selecciono “Aprobado”,<br>**Entonces** solo veo autos con certificado vigente.<br><br>**Scenario 2:**<br>**Dado** que no selecciono ningún filtro,<br>**Cuando** busco,<br>**Entonces** el sistema muestra todos los resultados. | EPIC05 |
| **US19** | Ver detalle del vehículo | Como comprador quiero ver la ficha completa del auto para conocer su historial y resultado de inspección. | **Scenario 1:**<br>**Dado** que encuentro un vehículo,<br>**Cuando** hago clic en “Ver detalles”,<br>**Entonces** accedo al informe técnico con datos visuales.<br><br>**Scenario 2:**<br>**Dado** que el informe está restringido,<br>**Cuando** intento acceder sin registro,<br>**Entonces** el sistema me solicita iniciar sesión. | EPIC05 |
| **US20** | Contacto con el vendedor | Como comprador quiero contactar al vendedor desde la misma plataforma para iniciar la negociación. | **Scenario 1:**<br>**Dado** que veo un vehículo que me interesa,<br>**Cuando** hago clic en “Contactar”,<br>**Entonces** puedo enviar un mensaje directo o solicitud.<br><br>**Scenario 2:**<br>**Dado** que ya envié una solicitud,<br>**Cuando** intento repetirla,<br>**Entonces** el sistema me avisa que ya fue enviada. | EPIC05 |
| **US21** | Notificaciones automáticas | Como usuario quiero recibir notificaciones sobre el estado de mis solicitudes e inspecciones. | **Scenario 1:**<br>**Dado** que mi inspección cambia de estado,<br>**Cuando** el sistema actualiza el registro,<br>**Entonces** recibo una notificación por correo o en la app.<br><br>**Scenario 2:**<br>**Dado** que tengo notificaciones sin leer,<br>**Cuando** abro el panel,<br>**Entonces** las veo agrupadas por tipo. | EPIC06 |
| **US22** | Soporte técnico | Como usuario quiero acceder a un chat o formulario de soporte para resolver dudas o incidencias. | **Scenario 1:**<br>**Dado** que tengo un problema,<br>**Cuando** abro la sección de soporte,<br>**Entonces** puedo escribir un mensaje y enviarlo al equipo técnico.<br><br>**Scenario 2:**<br>**Dado** que envío una consulta,<br>**Cuando** el equipo responde,<br>**Entonces** recibo una notificación con la respuesta. | EPIC06 |
| **US23** | Evaluación del servicio | Como usuario quiero calificar la atención y servicio recibido para mejorar la calidad de la plataforma. | **Scenario 1:**<br>**Dado** que completé una inspección,<br>**Cuando** aparece la encuesta de satisfacción,<br>**Entonces** puedo calificar con estrellas o comentarios.<br><br>**Scenario 2:**<br>**Dado** que ya evalué el servicio,<br>**Cuando** intento hacerlo nuevamente,<br>**Entonces** el sistema impide duplicados. | EPIC06 |
| **US24** | Modo oscuro | Como usuario frecuente quiero activar el modo oscuro para mejorar la visibilidad y reducir fatiga visual. | **Scenario 1:**<br>**Dado** que estoy en el panel de usuario,<br>**Cuando** activo el modo oscuro,<br>**Entonces** los colores y contrastes cambian correctamente.<br><br>**Scenario 2:**<br>**Dado** que cierro sesión,<br>**Cuando** vuelvo a ingresar,<br>**Entonces** el sistema recuerda mi preferencia. | EPIC06 |



| Epic/Story ID | Título | Descripción | Criterios de Aceptación | Relacionado con (Epic ID) |
|----------------|--------|-------------|--------------------------|--------------------------|
| **TS01** | Configuración del entorno | Configurar el entorno de desarrollo con backend y frontend integrados. | **Scenario 1:**<br>**Dado** que se instala el entorno,<br>**Cuando** se ejecuta el backend y frontend,<br>**Entonces** ambos funcionan correctamente en el mismo repositorio. | EPIC07 |
| **TS02** | Conexión a base de datos | Implementar la conexión segura con la base de datos MySQL. | **Scenario 1:**<br>**Dado** que existe la base de datos configurada,<br>**Cuando** se levanta el backend,<br>**Entonces** se establece conexión exitosa. | EPIC07 |
| **TS03** | API REST | Desarrollar endpoints REST para manejar solicitudes de inspección, usuarios y reportes. | **Scenario 1:**<br>**Dado** que se envía una solicitud válida,<br>**Cuando** el backend procesa la petición,<br>**Entonces** devuelve una respuesta JSON con estado 200. | EPIC07 |
| **TS04** | Integración Frontend–Backend | Conectar Angular con el backend Spring Boot para mostrar datos en tiempo real. | **Scenario 1:**<br>**Dado** que el backend expone endpoints,<br>**Cuando** Angular los consume,<br>**Entonces** se muestran las señales correctamente en el dashboard. | EPIC07 |
| **TS05** | Seguridad y autenticación JWT | Implementar seguridad mediante tokens JWT. | **Scenario 1:**<br>**Dado** que un usuario inicia sesión,<br>**Cuando** el backend genera el token,<br>**Entonces** las peticiones siguientes se autentican correctamente. | EPIC07 |
| **TS06** | Despliegue en servidor | Configurar despliegue en servidor para entorno de producción. | **Scenario 1:**<br>**Dado** que la app está lista,<br>**Cuando** se sube al servidor,<br>**Entonces** se ejecuta correctamente desde el dominio oficial. | EPIC07 |
| **TS07** | Pruebas y monitoreo | Implementar pruebas unitarias y monitoreo de logs para garantizar estabilidad. | **Scenario 1:**<br>**Dado** que se ejecutan las pruebas,<br>**Cuando** los módulos pasan las validaciones,<br>**Entonces** se generan reportes de cobertura y logs de errores. | EPIC07 |
...
<img src="Images/BounedIcertiReserva.png">
